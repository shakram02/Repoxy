...
class XidSynchronizerTest {
    ...
    void syncXid() {
        ...
        SocketDataEventArg replicaPackets = new SocketDataEventArg(SenderType.ReplicaRegion,
                conId, createFromArray(featuresRequest));
...
//        synchronizer.syncListXids(controllerPackets);
	...
	14 Features Reply
        ...
        SocketDataEventArg replyFirst = new SocketDataEventArg(SenderType.SwitchesRegion,
                conId, createFromArray(featuresReplyFirst));
        ...
        SocketDataEventArg replySecond = new SocketDataEventArg(SenderType.SwitchesRegion,
                conId, createFromArray(featuresReplySecond));

        synchronizer.syncListXids(conId, replySecond.getPackets());
    }

    private static ByteArrayDataOutput createFromArray(byte[] data) {
